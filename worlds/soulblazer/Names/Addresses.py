...
CHEST_DATA = 0x00AADE
WEAPON_STRENGTH_DATA = 0x100001
ARMOR_DEFENSE_DATA = 0x100012
WEAPON_REQUIRED_LEVEL_DATA = 0x10001A
STRINGS_START = 0x100040
RANDO_SETTINGS = 0x017730
STONES_REQUIRED = RANDO_SETTINGS
ACT_PROGRESSION = STONES_REQUIRED+1
OPEN_DEATHTOLL = ACT_PROGRESSION+1
RELEASE_CUTSCENES = OPEN_DEATHTOLL+1
...
EVENT_FLAGS_SIZE = 0x20
CHEST_OPENED_TABLE = 0x001A7E + WRAM_START
LAIR_FLAGS_SHADOW_TABLE = 0x001A9E + WRAM_START
LAIR_FLAGS_TABLE = 0x001ADE + WRAM_START
LAIR_FLAGS_SIZE = 0x35
